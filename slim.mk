...
# device
$(call inherit-product-if-exists, device/lge/geeb/full_geeb.mk)
...
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=slim.geeb.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    PRIVATE_BUILD_DESC="gee-user 4.3 JSS15 573038 release-keys" \
    BUILD_FINGERPRINT="lge/gee/geeb:4.3/JWR66V/737497:user/release-keys"
